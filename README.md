# Available .TAXI One-Word Domains (9,373)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C372%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-9%2C373%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,372-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **9,373 domains** on the canonical page below.
...
- `taxi.csv` — public CSV extract (9,372 rows)
- `taxi.json` — public JSON extract (9,372 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,372-row public sample | 9,373 live domains                               |
